...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?= base_url('img'); ?>/<?= $perusahaan['logo_header']; ?>" />
              ...
              <div class="app-brand justify-content-center ">
                <a href="index.html" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="<?= base_url('img'); ?>/<?= $perusahaan['logo']; ?>" alt="Logo">
                  </span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2"><?= $judul; ?></h4>
                ...
                ?>
                      ...
                      if ($session->getFlashdata('success')) {
                        ...
                        ?>
              <form id="formAuthentication" class="mb-3" action="<?= base_url('admin/ceklogin'); ?>" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <div class="form-control-icon">
                                    <i class="bi bi-person"></i><?php if ($session->getFlashdata('password')) echo $session->getFlashdata('password') ?>
                                </div>
                  </div>
                </div>
                <div class="mb-3">
